    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-screen-xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                {notes.length === 0 ? (
                    <Card onClick={handleNewNote} className="border-2 border-dashed border-gray-300 dark:border-gray-700 flex items-center justify-center h-[140px] cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200">
